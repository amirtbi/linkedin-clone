<template>
  <div class="flex w-full items-center justify-center px-[5rem]">
    <div class="flex max-w-[500px] mr-[2rem]">
      <h2 style="color: #8f5849" class="text-[3rem] font-normal">
        Welcome to your professional community
      </h2>
    </div>
    <div class="avatar rounded-[100%]">
      <svg
